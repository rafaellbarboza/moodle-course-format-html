 ...
 */
M.format_html.init = function(Y, the_editing_on, the_section_redirect, the_num_sections, the_shadebox_shown_array) {
    "use strict";
    this.ourYUI = Y;
    ...
    Y.use('json-parse', function (Y) {
        M.format_html.shadebox_shown_array = Y.JSON.parse(M.format_html.shadebox_shown_array);
    });
    ...
    if (the_editing_on) {
        ...
        M.format_html.shadebox.initialize_shadebox();
        M.format_html.shadebox.update_shadebox();
 ...
 */
M.format_html.icon_click = function(e) {
    "use strict";
    e.preventDefault();
 ...
 */
M.format_html.icon_toggle = function(e) {
    "use strict";
    e.preventDefault();
    if (this.selected_section_no != -1) { // Then a valid shown section has been selected.
        ...
        } else if (M.format_html.shadebox.shadebox_open == true) {
 ...
 * @param {Object} e Event object.
 */
M.format_html.arrow_left = function(e) {
    "use strict";
 ...
 * @param {Object} e Event object.
 */
M.format_html.arrow_right = function(e) {
    "use strict";
 ...
 */
M.format_html.change_selected_section = function(increase_section) {
    "use strict";
    if (this.selected_section_no != -1) { // Then a valid shown section has been selected.
        ...
        if (M.format_html.shadebox.shadebox_open == true) {
            this.icon_change_shown();
            this.update_arrows();
        }
    } //else {
 ...
 */
M.format_html.icon_change_shown = function() {
    "use strict";
 ...
 */
M.format_html.update_arrows = function() {
    "use strict";
 ...
 */
M.format_html.set_selected_section = function(starting_point, increase_section, initialise) {
    "use strict";
 ...
 */
M.format_html.update_selected_background = function(previous_no) {
    "use strict";
};
 ...
 */
M.format_html.find_next_shown_section = function(starting_point, increase_section) {
    "use strict";
    var found = false;
...
M.format_html.shadebox = M.format_html.shadebox || {
 ...
 */
M.format_html.shadebox.initialize_shadebox = function() {
    "use strict";
    ...
    var top = 50;
    var mainregion = M.format_html.ourYUI.one('#region-main');
    if (mainregion) {
 ...
 */
M.format_html.shadebox.toggle_shadebox = function() {
    "use strict";
 ...
 * Shows the shade box.
 */
M.format_html.shadebox.show_shadebox = function() {
    "use strict";
 ...
 * Hides the shade box.
 */
M.format_html.shadebox.hide_shadebox = function() {
    "use strict";
 ...
 */
M.format_html.shadebox.update_shadebox = function() {
    "use strict";
 ...
 * Author unknown.
 */
M.format_html.shadebox.get_page_height = function() {
    "use strict";
    var yScroll;
